...
const shuffleTheArrayTest = () => arrayIsSame([2, 3, 5, 4, 1, 7], ShuffleTheArray(3, [2, 5, 1, 3, 4, 7]));
const kidsWithCandiesTest = () => kidsWithCandies([2, 3, 5, 1, 3], 3).some((bool) => bool);
...
const numberSmallerThanGivenTest = () => arrayIsSame([4, 0, 1, 1, 3], numberSmallerThanGiven([8, 1, 2, 2, 3]));
const decompressRunLengthEncodedListTest = () => arrayIsSame([2, 4, 4, 4], decompressRunLengthEncodedList([1, 2, 3, 4]));
const subtractTheProductAndSumOfDigitsOfIntergerTest = () => 15 === subtractTheProductAndSumOfDigitsOfInterger(234);
const amountOfStringLengthOfNumbersTest = () => 1 === amountOfStringLengthOfNumbers([555, 901, 482, 1771]);
const createTargetInArrayTest = () => arrayIsSame([0, 4, 1, 3, 2], createTargetInArray([0, 1, 2, 3, 4], [0, 1, 2, 2, 1]));
